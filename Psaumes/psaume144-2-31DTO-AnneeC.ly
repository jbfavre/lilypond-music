...
scoreHeader = \header {
  title = "Psaume 144"
  subtitle = \markup { \column { "31e dimanche du Temps Ordinaire" "Année C" }}
  composer = "Jean Baptiste Favre"
  poet = "AELF"
  date = "Clichy la Garenne, juin 2022"
}
  ...
  \override #'(font-size . 1.8)
  {
    \column {
      ...
      \fill-line {
        ...
        \left-column{
          \concat { \typewriter "4. " "Le Seigneur est vrai en to" \underline u "t ce qu'il dit"}
          \concat { \typewriter "   " "fidèle en to" \underline u "t ce qu’il fait." }
          \concat { \typewriter "   " "Le Seigneur souti" \underline e "nt tous ceux qui" }
          \concat { \typewriter "   " "     tombent," }
