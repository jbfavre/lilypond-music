...
scoreHeader = \header {
  title = "Psaume 144"
  subtitle = \markup { \column { "5e dimanche de Pâques" "Année C" }}
  composer = "Jean Baptiste Favre"
  poet = "AELF"
  date = "Clichy la Garenne, mai 2022"
}
...
antiphonMusicSoprano = \relative c'' {
  \partial 8 g8 bf4 r8 g8 c4 r8 a8 c bf bf a a g g4. g8 g4 g g2
}

antiphonMusicAlto = \relative g' {
  \partial 8 r8 r8 g8 g g g4 r8 g8 a bf a a g g ef4.  ef8 ef4 ef d2
  }
...
antiphonMusicBass =  \relative f {
  \partial 8 r8 r8 g8 f f ef4 r8 c8 g'4 f ef d (c) c c g2
  }
  ...
  \override #'(font-size . 1.8)
  {
    \column {
      ...
      \fill-line {
        ...
        \hspace #1
        \left-column {
          \concat { \typewriter "2. " "Que tes œuvres, Seigne" \underline u "r, te rendent grâce" }
      ...
      \fill-line {
        \column{
          \concat { \typewriter "3. " "Ils annonceront aux h" \underline o "mmes tes exploits,," }
          \concat { \typewriter "   " "la gloire et l'écl" \underline a "t de ton règne&nbsp;:" }
          \concat { \typewriter "   " "ton règne, un r" \underline è "gne éternel," }
          \concat { \typewriter "   " "ton empire, pour les " \underline â "ges des âges." }
        }
      }
    }
  }
