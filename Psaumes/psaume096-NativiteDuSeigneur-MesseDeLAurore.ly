...
scoreHeader = \header {
  title = "Psaume 96"
  subtitle = \markup { \column { "Nativité du Seigneur" "Messe de l'Aurore" }}
...
antiphonRythm = {
 \partial 4 s4 s2*3 \time 3/4 s2. s2.*2 \bar "|." \break
}
antiphonMusicSoprano = \relative c' {
  \markCustom "Antienne"
  \partial 4 c8 d e4 e8 f g4 r8 g8 a c b a g2
  g8 g a4 a b c2.
  }

antiphonMusicAlto = \relative c' {
  \partial 4 g8 g c4 c8 c e4 r8 e8 c f f f d2 d8 d f4 f g g2.
  }

antiphonMusicTenor =  \relative c {
  \partial 4 e8 e a4 a8 a b4 r8 b8 a a b b b2 b8 b c4 d d e2.
  }

antiphonMusicBass =  \relative c {
  \partial 4 c8 b a4 a'8 f e4 r8 e8 f f d d g2 g8 g f4 d g c,2.
  }

antiphonLyrics = \lyricmode {
  La lu -- miè -- re~au -- jour -- d'hui a res -- plen -- di sur nous&nbsp;:
