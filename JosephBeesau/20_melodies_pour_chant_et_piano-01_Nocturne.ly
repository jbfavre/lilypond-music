...
\header {
  dedication = \markup{ \sans \small \italic \concat {"Au maître " \bold { "D" \smallCaps "éodat de " "S" \smallCaps "évérac" } }}
  title = \markup{ \sans "Nocturne"}
  subtitle = \markup{ \sans "N°1"}
  composer = \markup { \sans \right-column { "Musique de" \bold \concat { "J. B" \smallCaps éesau }}}
  poet = \markup { \sans \column { "Poésie de" \bold \concat { "Jean  L" \smallCaps ahor }}}
